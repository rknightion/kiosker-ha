...
2. In the Kiosker app, enable the API and copy the **Access Token** (keep the **Base URL** handy for manual setup).
3. In Home Assistant, add the **Kiosker** integration and follow the prompts (auto-discovered devices only ask for the token).
